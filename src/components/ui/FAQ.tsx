...
type FAQItemProps = { faq: FAQ; index: number; isOpen: boolean; onToggle: () => void };
  ...
  return (
    ...
    >
      <button onClick={onToggle} className="w-full py-8 flex items-center justify-between text-left cursor-pointer group">
        ...
        <motion.span animate={{ rotate: isOpen ? 45 : 0 }} transition={{ duration: 0.3, ease: [0.16, 1, 0.3, 1] }} className="w-8 h-8 flex-shrink-0 text-kc-gold/60 group-hover:text-kc-gold transition-colors">
