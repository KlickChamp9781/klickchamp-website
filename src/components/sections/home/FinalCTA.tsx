    ...
    <section className="kc-section relative overflow-hidden">
      <div className="kc-container">
        <motion.div
          ...
          className="relative rounded-[var(--kc-radius-2xl)] p-16 md:p-20 lg:p-24 text-center"
        >
          {/* Background layers */}
          ...
          {/* Glow orbs */}
          <div className="absolute top-0 left-1/4 w-80 h-80 bg-kc-gold/5 rounded-full blur-[120px]" />
          <div className="absolute bottom-0 right-1/4 w-64 h-64 bg-kc-gold/3 rounded-full blur-[100px]" />
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            <motion.p
              ...
              className="text-overline font-[family-name:var(--kc-font-heading)] kc-gold-text mb-5"
            >
              Ready to Grow?
            </motion.p>
            ...
            <motion.h2
              ...
              className="text-[var(--kc-text-display)] font-[family-name:var(--kc-font-heading)] font-bold text-kc-white mb-5 leading-tight"
            >
              Let&apos;s Build Your
              <br />
            ...
            <motion.p
              ...
              className="text-[var(--kc-text-body-xl)] text-kc-gray-400 mb-12 max-w-xl mx-auto"
            >
