...
export function FinalCTA() {
  return (
    <section className="relative overflow-hidden border-t border-kc-white/5">
        ...
        <div className="kc-container">
          ...
          >
            ...
            <motion.h2
              ...
              className="text-[var(--kc-text-display)] font-[family-name:var(--kc-font-heading)] font-bold text-kc-white mb-6 leading-tight"
            >
              Let&apos;s Build Your
              <br />
            ...
            <motion.p
              ...
              className="text-[var(--kc-text-body-xl)] text-kc-gray-400 mb-12 max-w-lg mx-auto"
            >
