...
export function FinalCTA() {
  return (
    <section className="relative overflow-hidden bg-kc-black-pure border-t border-kc-white/[0.04]">
      <div className="kc-container relative z-10" style={{ paddingTop: "5rem", paddingBottom: "5rem" }}>
        <motion.div
        ...
        >
          ...
          <p className="text-[var(--kc-text-body-xl)] text-kc-gray-500 mb-12 max-w-lg mx-auto leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-5">
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-3 px-10 py-5 rounded-[var(--kc-radius-lg)] text-kc-gray-400 font-heading font-medium text-lg hover:text-kc-white transition-all duration-300"
            >
